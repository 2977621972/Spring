...
<body>
	<form action="${pageContext.request.contextPath }/func/add.action" method="post">
	<div class="am-u-sm-12" style="margin-top: 20px">
		...
		<table class="am-table am-table-bordered">
			...
			<tr>
				...
				<td align="left">
					<select name="pid">
						<option value="0" ${func.pid==0?"selected='selected'":""}>无上级菜单</option>
			...
			<tr>
				...
				<td align="left">
					<label class="radio-inline">
					  <input type="radio" name="activate" id="inlineRadio1" value="1"> 启用
					</label>
					<label class="radio-inline">
					  <input type="radio" name="activate" id="inlineRadio2" value="0"> 关闭
					</label>
