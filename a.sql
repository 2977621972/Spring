...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES ('000001', 'admin', 'admin', '', '1', '105000010199', '管理部', '1', 0, 'admin', NULL, NULL);
...
CREATE TABLE `good`  (
  ...
  `goodmodel` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `goodproducer` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `depodid` int(11) NULL DEFAULT NULL,
  `depodnum` int(11) NULL DEFAULT NULL,
  `spare1` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare2` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare3` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare4` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare5` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `goodnum` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `good` VALUES (31, '计算器（个）', 'J2001', '晨光科技', '个', NULL, 18, NULL, NULL, NULL, '0', NULL, NULL, NULL, NULL, '');
...
INSERT INTO `good` VALUES (34, '桌（张）', 'MZ3020', '欧亚达建材', '张', 500.00, 12, 5, NULL, NULL, '0', '2', NULL, NULL, NULL, NULL);
...
CREATE TABLE `goods`  (
  ...
  `supplier` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `in_depod`  (
  ...
  `indepodtime` datetime NULL DEFAULT NULL COMMENT '入库时间',
  `buyer` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '采购员',
  `depodprincipal` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '仓库负责人',
  `spare1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备用',
  `spare2` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare3` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare4` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare5` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- Records of in_depod
-- ----------------------------
INSERT INTO `in_depod` VALUES (7, 19, '支', 50, '2018-07-01 15:06:25', '张', '王', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (8, 20, '张', 10, '2018-07-01 15:06:25', '张', '王', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (9, 21, 'dfs', 12, '2018-07-01 15:27:07', 'vcc', '李', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (10, 22, '件', 100, '2018-07-01 14:45:59', '李', '李', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (11, 23, '个', 20, '2018-07-01 14:45:59', '李', '李', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (12, 24, '个', 30, '2018-07-01 17:51:52', 'zhang', '李', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (13, 31, '个', 20, '2018-07-01 09:58:49', '江', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (14, 32, '个', 30, '2018-07-01 09:58:49', '江', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (15, 33, '个', 20, '2018-07-01 09:07:11', '明', '华', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (16, 34, '张', 2, '2018-07-01 09:07:11', '明', '华', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `in_depod` VALUES (17, 34, '张', 10, '2018-07-03 22:34:47', '5465', 'admin', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `msgboard`  (
  ...
  `msgboardtime` datetime NULL DEFAULT NULL,
...
CREATE TABLE `out_depod`  (
  ...
  `unit` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位',
  `num` int(11) NULL DEFAULT NULL COMMENT '数量',
  `outdepodtime` datetime NULL DEFAULT NULL COMMENT '出库时间',
  `usedepartment` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '使用部门',
  `responsible` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '责任人',
  `depodprincipal` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '仓库负责人',
  `spare1` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备用',
  `spare2` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `spare3` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `out_depod` VALUES (1, 21, 'dfs', 12, '2018-07-01 14:24:32', '专卖处', '网三', '李', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `out_depod` VALUES (2, 23, '个', 11, '2018-07-01 16:54:06', '办公室', '曲奇', '李', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `out_depod` VALUES (3, 31, '个', 2, '2018-07-03 22:35:21', '4454', '6646', 'admin', NULL, NULL, NULL, NULL, NULL);
